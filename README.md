...
2. Edit Res-CR-Net_train.py. The only thing to modify here are a) the choice of loss and metrics in the TRAINING section and in the EVALUATION section, and b) the number of epochs and steps. For example:
